...
def process_stk_callback(request):
    ...
    amount = stk_callback_response["Body"]["stkCallback"]["CallbackMetadata"]["Item"][
        0
    ]["Value"]
    transaction_id = stk_callback_response["Body"]["stkCallback"]["CallbackMetadata"][
        "Item"
    ][1]["Value"]
    user_phone_number = stk_callback_response["Body"]["stkCallback"][
        "CallbackMetadata"
    ]["Item"][4]["Value"]
